      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-[53px] w-full">
          ...
          <nav className="hidden lg:flex space-x-6 items-center">
            ...
            <button
              type="button"
              className={`hs-dark-mode ${theme === 'dark' ? 'hidden' : 'flex'} items-center gap-x-2 py-2 px-3 bg-white/10 rounded-full text-sm text-white hover:bg-white/20 focus:outline-hidden focus:bg-white/20`}
            ...
            <button
              type="button"
              className={`hs-dark-mode ${theme === 'light' ? 'hidden' : 'inline-flex'} items-center gap-x-2 py-2 px-3 bg-white/10 rounded-full text-sm text-white hover:bg-white/20 focus:outline-hidden focus:bg-white/20`}
